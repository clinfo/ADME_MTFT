...
test_base_path="/data_st01/drug/itosho/ADMET/configs/accuracy_drug/adme/multitask/test/*/*"
...
acc_path="/data_st01/drug/itosho/ADMET/configs/accuracy_drug/adme/multitask/evaluation.py"
python $acc_path
